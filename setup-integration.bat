...
REM Este script configura la integración entre Jetstream y Filament

REM Asegurarse de que las migraciones están aplicadas
php artisan migrate

REM Ejecutar el seeder de roles y usuarios
php artisan db:seed --class=Auth\RolesAndPermissionsSeeder

REM Asignar roles a usuarios existentes si es necesario
