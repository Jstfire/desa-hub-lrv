...
return [
    ...
    'profiles' => [
        'default' => [
            ...
            'toolbar' => 'undo redo removeformat | fontfamily fontsize fontsizeinput font_size_formats styles | bold italic underline | rtl ltr | alignjustify alignleft aligncenter alignright | numlist bullist outdent indent | forecolor backcolor | blockquote table toc hr | image link media codesample emoticons | code wordcount fullscreen',
        ...
        'simple' => [
            ...
            'toolbar' => 'removeformat | bold italic | rtl ltr | numlist bullist | link emoticons | code',
            'upload_directory' => null,
            'height' => 200,
        ],
        ...
        'minimal' => [
            ...
            'toolbar' => 'bold italic link numlist bullist | code',
            'upload_directory' => null,
            'height' => 150,
        ],
        ...
        'full' => [
            ...
            'toolbar' => 'undo redo removeformat | fontfamily fontsize fontsizeinput font_size_formats styles | bold italic underline | rtl ltr | alignjustify alignright aligncenter alignleft | numlist bullist outdent indent accordion | forecolor backcolor | blockquote table toc hr | image link anchor media codesample emoticons | visualblocks print preview code wordcount fullscreen help',
            'upload_directory' => null,
            'height' => 400,
        ],
    ],
