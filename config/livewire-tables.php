...
return [
     ...
     * You can use environment variable to set different paths for different environments
     */
    'script_base_path' => env('LIVEWIRE_TABLES_ASSET_PATH', 'vendor/rappasoft/livewire-tables'),
