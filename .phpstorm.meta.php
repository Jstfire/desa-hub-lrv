...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\desa-hub-lrv\public\storage' => 'string',
...
'database.redis.cache.port','database.redis.cache.database','filament.broadcasting','filament.default_filesystem_disk','filament.assets_path',
'filament.cache_path','filament.livewire_loading_delay','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\desa-hub-lrv\\public\\storage',
...
'livewire-tables.multiSelectDropdownFilter.defaultConfig','livewire-tables.events.enableUserForEvent','activitylog.enabled','activitylog.delete_records_older_than_days','activitylog.default_log_name',
...
'debugbar.queries.explain','filament.exports.download','filament.imports.failed-rows.download','filament.superadmin.auth.logout','filament.superadmin.pages.dashboard',
'filament.superadmin.resources.beritas.index','filament.superadmin.resources.beritas.create','filament.superadmin.resources.beritas.edit','filament.superadmin.resources.data-sektorals.index','filament.superadmin.resources.data-sektorals.create',
'filament.superadmin.resources.data-sektorals.edit','filament.superadmin.resources.desas.index','filament.superadmin.resources.desas.create','filament.superadmin.resources.desas.edit','filament.superadmin.resources.footers.index',
'filament.superadmin.resources.footers.create','filament.superadmin.resources.footers.edit','filament.superadmin.resources.galeris.index','filament.superadmin.resources.galeris.create','filament.superadmin.resources.galeris.edit',
'filament.superadmin.resources.layanan-publiks.index','filament.superadmin.resources.layanan-publiks.create','filament.superadmin.resources.layanan-publiks.edit','filament.superadmin.resources.metadata.index','filament.superadmin.resources.metadata.create',
'filament.superadmin.resources.metadata.edit','filament.superadmin.resources.pengaduans.index','filament.superadmin.resources.pengaduans.create','filament.superadmin.resources.pengaduans.edit','filament.superadmin.resources.pengaduans.view',
'filament.superadmin.resources.ppids.index','filament.superadmin.resources.ppids.create','filament.superadmin.resources.ppids.edit','filament.superadmin.resources.publikasis.index','filament.superadmin.resources.publikasis.create',
'filament.superadmin.resources.publikasis.edit','filament.superadmin.resources.visitors.index','filament.superadmin.resources.visitors.view','login','login.store',
...
'two-factor.confirm','two-factor.disable','two-factor.qr-code','two-factor.secret-key','two-factor.recovery-codes','profile.show','teams.create','teams.show','current-team.update',
'team-invitations.accept','sanctum.csrf-cookie','livewire.update',
'livewire.upload-file','livewire.preview-file','tinymce.upload',
'dashboard','desa.index','desa.berita','desa.berita.detail','desa.layanan-publik',
'desa.profil','desa.monografi.download','desa.publikasi','desa.publikasi.download','desa.data-sektoral',
'desa.data-sektoral.detail','desa.metadata','desa.metadata.jenis','desa.ppid','desa.ppid.download',
'desa.galeri','desa.galeri.jenis','desa.pengaduan','desa.pengaduan.store','storage.local',);
...
'components.validation-errors','components.welcome','dashboard','emails.team-invitation','filament.forms.components.tiny-editor',
'frontend.desa.berita.index','frontend.desa.berita.show','frontend.desa.data-sektoral.index','frontend.desa.data-sektoral.show','frontend.desa.galeri.index',
'frontend.desa.index','frontend.desa.layanan-publik','frontend.desa.layouts.main','frontend.desa.metadata.index','frontend.desa.metadata.jenis',
'frontend.desa.pengaduan.form','frontend.desa.ppid.index','frontend.desa.profil','frontend.desa.publikasi.index','layouts.app',
...
'terms','welcome','filament-actions::badge-action','filament-actions::badge-group','filament-actions::button-action',
...
'laravel-exceptions::minimal','livewire-tables::components.external.filters.livewire-array-filter','livewire-tables::components.forms.checkbox','livewire-tables::components.includes.actions','livewire-tables::components.includes.loading',
...
'livewire-tables::components.tools.filter-pills.buttons.reset-filter','livewire-tables::components.tools.filter-pills.pills-item','livewire-tables::components.tools.filters.boolean','livewire-tables::components.tools.filters.date','livewire-tables::components.tools.filters.date-range',
...
'livewire-tables::includes.debug','livewire-tables::includes.filter-pill','livewire-tables::includes.offline','livewire-tables::specific.bootstrap-4.pagination','livewire-tables::specific.bootstrap-4.simple-pagination',
'livewire-tables::specific.tailwind.pagination','livewire-tables::specific.tailwind.simple-pagination','livewire-tables::stubs.custom','livewire::bootstrap','livewire::simple-bootstrap',
...
'auth.0','pagination.0','passwords.0','validation.0','filament-actions::associate.single.label',
...
'filament-forms::components.rich_editor.toolbar_buttons.strike','filament-forms::components.rich_editor.toolbar_buttons.underline','filament-forms::components.rich_editor.toolbar_buttons.undo','filament-forms::components.select.actions.create_option.modal.heading','filament-forms::components.select.actions.create_option.modal.actions.create.label',
'filament-forms::components.select.actions.create_option.modal.actions.create_another.label','filament-forms::components.select.actions.edit_option.modal.heading','filament-forms::components.select.actions.edit_option.modal.actions.save.label','filament-forms::components.select.boolean.true','filament-forms::components.select.boolean.false',
...
'filament-infolists::components.0','filament-notifications::database.modal.heading','filament-notifications::database.modal.actions.clear.label','filament-notifications::database.modal.actions.mark_all_as_read.label','filament-notifications::database.modal.empty.heading',
...
'filament-tables::table.sorting.fields.direction.label','filament-tables::table.sorting.fields.direction.options.asc','filament-tables::table.sorting.fields.direction.options.desc','livewire-tables::core.All','livewire-tables::core.All Columns',
'livewire-tables::core.Applied Filters','livewire-tables::core.Applied Sorting','livewire-tables::core.Bulk Actions','livewire-tables::core.Clear','livewire-tables::core.Columns',
'livewire-tables::core.Debugging Values','livewire-tables::core.Deselect All','livewire-tables::core.Done Reordering','livewire-tables::core.Filters','livewire-tables::core.not_applicable',
...
'livewire-tables::core.Search','livewire-tables::core.Select All','livewire-tables::core.Showing','livewire-tables::core.to','livewire-tables::core.Yes',
'livewire-tables::core.You are currently selecting all','livewire-tables::core.You are not connected to the internet','livewire-tables::core.You have selected',);
