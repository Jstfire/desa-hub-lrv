...
<body class="bg-gray-50 dark:bg-gray-900 min-h-screen">
    <div class="flex flex-col justify-center items-center px-4 min-h-screen">
        <div class="text-center">
            ...
            <!-- Error Message -->
            <h1 class="mb-4 font-bold text-gray-900 dark:text-white text-6xl">404</h1>
            <h2 class="mb-2 font-semibold text-gray-800 dark:text-gray-200 text-2xl">Halaman Tidak Ditemukan</h2>
