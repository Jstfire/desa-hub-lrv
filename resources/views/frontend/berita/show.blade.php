                    ...
                    <div class="mb-8">
                        ...
                        @else
                            <div class="py-12 text-center">
                                <div
                                    class="flex justify-center items-center bg-gray-200 dark:bg-gray-700 mx-auto mb-4 rounded-full w-16 h-16">
                                ...
                                <h4 class="mb-2 font-semibold text-gray-600 dark:text-gray-400 text-lg">Belum Ada Berita
                                    Terkait</h4>
                                <p class="text-gray-500 dark:text-gray-500">Tidak ada berita terkait yang tersedia saat
                                    ini.</p>
                            </div>
                        @endif
                    </div>
