                    ...
                    <div class="mb-8">
                        ...
                        @else
                            <div class="py-12 text-center">
                                <div class="flex justify-center items-center bg-gray-200 dark:bg-gray-700 mx-auto mb-4 rounded-full w-16 h-16">
                                    <svg class="w-8 h-8 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" />
                                    </svg>
                                </div>
                                <h4 class="mb-2 font-semibold text-gray-600 dark:text-gray-400 text-lg">Belum Ada Berita Terkait</h4>
                                <p class="text-gray-500 dark:text-gray-500">Tidak ada berita terkait yang tersedia saat ini.</p>
                            </div>
                        @endif
                    </div>
                </div>
