...
@section('title', 'Form Pengaduan - ' . $desa->nama_lengkap)
...
@section('content')
    <div class="mx-auto px-4 py-8 container">
        <div class="mx-auto max-w-3xl">
            ...
            @if (session('success'))
                <div class="bg-green-50 mb-6 px-4 py-3 border border-green-200 rounded-md text-green-800"
                    data-auto-hide="5000">
                    <div class="flex">
            ...
            @if (session('error'))
                <div class="bg-red-50 mb-6 px-4 py-3 border border-red-200 rounded-md text-red-800" data-auto-hide="5000">
                    <div class="flex">
                        <svg class="mr-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
            ...
            <div class="bg-card shadow-sm p-6 border border-border rounded-lg">
                <form action="{{ route('desa.pengaduan.store', $desa->uri) }}" method="POST" data-toast-submit>
                    ...
                    <!-- Informasi Pengadu -->
                    <div class="mb-6">
                        <h3 class="mb-4 pb-2 border-b border-border font-semibold text-foreground text-lg">
                            Informasi Pengirim
                        </h3>

                        <div class="gap-4 grid grid-cols-1 md:grid-cols-2">
                            <div class="mb-4">
                                <label for="nama" class="block mb-2 font-medium text-foreground text-sm">Nama Lengkap
                            ...
                            <div class="mb-4">
                                <label for="email" class="block mb-2 font-medium text-foreground text-sm">Email <span
                            ...
                            <div class="mb-4">
                                <label for="telepon" class="block mb-2 font-medium text-foreground text-sm">Nomor
                                    Telepon</label>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-4">
                            <label for="judul" class="block mb-2 font-medium text-foreground text-sm">Judul Pengaduan
                                <span class="text-destructive">*</span></label>
                        ...
                        <div class="mb-4">
                            <label for="isi" class="block mb-2 font-medium text-foreground text-sm">Isi Pengaduan <span
                                    class="text-destructive">*</span></label>
                        ...
                        <div class="mb-4">
                            <label for="lampiran" class="block mb-2 font-medium text-foreground text-sm">Link Lampiran
                                (opsional)</label>
