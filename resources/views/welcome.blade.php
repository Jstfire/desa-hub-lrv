...
<head>
    ...
    <title>DesaHub - Sistem Terintegrasi Desa/Kelurahan</title>
    <meta name="description" content="Sistem terintegrasi untuk mengelola dan menyajikan informasi desa/kelurahan">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>

<body class="bg-gradient-to-br from-blue-50 dark:from-gray-900 to-indigo-100 dark:to-gray-800 min-h-screen">
    <!-- Navigation -->
            ...
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <h1 class="font-bold text-gray-900 dark:text-white text-2xl">DesaHub</h1>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                    <button data-theme-toggle
                        class="bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 p-2 rounded-lg text-gray-600 dark:text-gray-300 transition-colors">
                    ...
                    <a href="{{ route('login') }}"
                        class="text-gray-600 hover:text-gray-900 dark:hover:text-white dark:text-gray-300">Login</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <body class="flex flex-col lg:justify-center items-center bg-[#FDFDFC] p-6 lg:p-8 min-h-screen text-[#1b1b18]">
                    ...
                    @auth
                        @if (auth()->user()->hasRole(['superadmin', 'admin_desa', 'operator_desa']))
                            <a href="{{ url('/dashboard') }}"
                                class="inline-block px-5 py-1.5 border border-[#19140035] hover:border-[#1915014a] rounded-sm text-[#1b1b18] text-sm leading-normal">
                                Panel Admin
                            </a>
                        @endif
                    @else
                        <a href="{{ route('login') }}"
                            class="inline-block px-5 py-1.5 border hover:border-[#19140035] border-transparent rounded-sm text-[#1b1b18] text-sm leading-normal">
                            Admin Login
                        </a>
                    @endauth
                </nav>
        ...
        <div
            ...
            <main class="flex lg:flex-row flex-col-reverse w-full max-w-[335px] lg:max-w-4xl">
                <div
                    class="flex-1 bg-white shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] p-6 lg:p-20 pb-12 lg:rounded-tl-lg rounded-bl-lg rounded-br-lg lg:rounded-br-none text-[13px] leading-[20px]">
                    <h1 class="mb-1 font-medium">Let's get started</h1>
                    <p class="mb-2 text-[#706f6c]">Laravel has an incredibly rich ecosystem. <br>We suggest starting
                        with the following.</p>
                    <ul class="flex flex-col mb-4 lg:mb-6">
                        <li
                            class="before:top-1/2 before:bottom-0 before:left-[0.4rem] before:absolute relative flex items-center gap-4 py-2 before:border-[#e3e3e0] before:border-l">
                            <span class="relative bg-white py-1">
                                <span
                                    class="flex justify-center items-center bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] border border-[#e3e3e0] rounded-full w-3.5 h-3.5">
                                    <span class="bg-[#dbdbd7] rounded-full w-1.5 h-1.5"></span>
                                </span>
                            </span>
                            <span>
                                Read the
                                <a href="https://laravel.com/docs" target="_blank"
                                    class="inline-flex items-center space-x-1 ml-1 font-medium text-[#f53003] underline underline-offset-4">
                        ...
                        <li
                            class="before:top-0 before:bottom-1/2 before:left-[0.4rem] before:absolute relative flex items-center gap-4 py-2 before:border-[#e3e3e0] before:border-l">
                            <span class="relative bg-white py-1">
                                <span
                                    class="flex justify-center items-center bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] border border-[#e3e3e0] rounded-full w-3.5 h-3.5">
                                    <span class="bg-[#dbdbd7] rounded-full w-1.5 h-1.5"></span>
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <a href="https://cloud.laravel.com" target="_blank"
                                class="inline-block bg-[#1b1b18] hover:bg-black px-5 py-1.5 border border-black hover:border-black rounded-sm text-white text-sm leading-normal">
                                Deploy now
                            </a>
                        </li>
                    </ul>
                ...
                <div
                    class="relative bg-[#fff2f2] -mb-px lg:mb-0 lg:-ml-px rounded-t-lg lg:rounded-t-none lg:rounded-r-lg w-full lg:w-[438px] aspect-[335/376] lg:aspect-auto overflow-hidden shrink-0">
                    {{-- Laravel Logo --}}
                    <svg class="opacity-100 starting:opacity-0 w-full max-w-none text-[#F53003] transition-all translate-y-0 starting:translate-y-6 duration-750"
                    ...
                    {{-- Light Mode 12 SVG --}}
                    <svg class="relative -mt-[4.9rem] lg:-mt-[6.6rem] -ml-8 lg:ml-0 w-[448px] max-w-none"
                    ...
                    {{-- Dark Mode 12 SVG --}}
                    <svg class="hidden relative -mt-[4.9rem] lg:-mt-[6.6rem] -ml-8 lg:ml-0 w-[448px] max-w-none"
                        viewBox="0 0 440 376" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g
                            class="opacity-100 starting:opacity-0 transition-all translate-y-0 starting:translate-y-4 duration-750 delay-300">
                            <path
                    ...
                    <div
                        class="absolute inset-0 shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] rounded-t-lg lg:rounded-t-none lg:rounded-r-lg">
                    </div>
                </div>
            </main>
        </div>
