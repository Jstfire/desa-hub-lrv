...
class DataSektoralResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Data Sektoral';
    ...
    public static function getEloquentQuery(): Builder
    {
        ...
        try {
            ...
            // Note: This should work at runtime with the hasRole method, but the IDE doesn't recognize it
            ...
            Log::error('Error in DataSektoralResource query: ' . $e->getMessage());
        }
